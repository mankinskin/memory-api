...
<!-- rule-api:entry id=16786c84-4e99-4041-8292-a962d907c541 slug=spec-api/generated-documents/summary/l1 -->
# Summary
...
<!-- rule-api:entry id=91b389d0-a9c9-458c-8aa8-d51627b629c7 slug=spec-api/generated-documents/summary/problem/l5 -->
## Problem

Today the document-generation path lives almost entirely in `rule-api`:

<!-- rule-api:entry id=7c113526-c4e7-42d4-8c61-b3c0905cbb9c slug=spec-api/generated-documents/summary/problem/l9 -->
...
<!-- rule-api:entry id=aeeb9889-1972-4b3e-8cdd-50f64bcc5b6b slug=spec-api/generated-documents/summary/problem/l16 -->
...
<!-- rule-api:entry id=cf4a19a7-6fc9-4d1a-920a-7e9734bf02fc slug=spec-api/generated-documents/summary/proposed-model/shared-builder-seam/l20 -->
### Shared builder seam

Introduce a shared builder layer under `memory-viewers/memory-api/crates/` that owns:

<!-- rule-api:entry id=c25c3b1c-5615-4dd5-aaa2-c39ea6bbac50 slug=spec-api/generated-documents/summary/proposed-model/shared-builder-seam/l24 -->
...
<!-- rule-api:entry id=7f4e668c-3037-4d51-9954-bead0f4eb25e slug=spec-api/generated-documents/summary/proposed-model/shared-builder-seam/l28 -->
This layer should be generic over the domain adapter that supplies snippet records and any domain-specific metadata.

<!-- rule-api:entry id=7e6f64bb-5b78-47fc-9b26-e1f3fb787d20 slug=spec-api/generated-documents/summary/proposed-model/domain-adapters/l30 -->
### Domain adapters
...
<!-- rule-api:entry id=0ff22ee2-e5a5-4ecf-9f3b-299dba241074 slug=spec-api/generated-documents/summary/proposed-model/spec-document-generation/l36 -->
...
<!-- rule-api:entry id=c92cfd00-ffaf-4951-8e65-da75a56163a6 slug=spec-api/generated-documents/summary/proposed-model/spec-document-generation/l40 -->
...
<!-- rule-api:entry id=f8b3cea0-fb0b-455c-bf1f-806b695482f1 slug=spec-api/generated-documents/summary/non-goals/l42 -->
## Non-goals
...
<!-- rule-api:entry id=21c67de3-06bb-42ca-8819-b82ef2e4a531 slug=spec-api/generated-documents/summary/acceptance-criteria/l48 -->
## Acceptance criteria
...
<!-- rule-api:entry id=2c4f3957-5377-4cf0-9050-512c7a26f2f7 slug=spec-api/generated-documents/summary/next-slice-rule-target-backed-spec-artifacts/l56 -->
...
<!-- rule-api:entry id=23dff709-4a4f-4a53-b767-4feb9e32c4bf slug=spec-api/generated-documents/summary/next-slice-rule-target-backed-spec-artifacts/l60 -->
...
<!-- rule-api:entry id=42ad6525-7fe1-4739-9d63-58e3efafe12e slug=spec-api/generated-documents/summary/next-slice-rule-target-backed-spec-artifacts/descriptor-contract/l65 -->
### Descriptor contract
...
<!-- rule-api:entry id=a59e9e3c-dfbd-45ba-a3ba-5c91d7a17dde slug=spec-api/generated-documents/summary/next-slice-rule-target-backed-spec-artifacts/descriptor-contract/l69 -->
```toml
[body]
config = "rule-targets.yaml"
target = "body"

<!-- rule-api:entry id=c765faa0-cec1-4196-8757-38b4de8d181b slug=spec-api/generated-documents/summary/next-slice-rule-target-backed-spec-artifacts/descriptor-contract/l74 -->
[sections.requirements]
config = "rule-targets.yaml"
target = "requirements"

<!-- rule-api:entry id=a281bc55-4795-4c5b-be04-f7e7bcc477a0 slug=spec-api/generated-documents/summary/next-slice-rule-target-backed-spec-artifacts/descriptor-contract/l78 -->
[sections.design]
config = "spec/rule-targets.yaml"
target = "design"
```

<!-- rule-api:entry id=65204c60-650a-4f69-9fe5-852434df3dc4 slug=spec-api/generated-documents/summary/next-slice-rule-target-backed-spec-artifacts/descriptor-contract/l83 -->
The descriptor is intentionally artifact-oriented rather than rule-filter-oriented:

<!-- rule-api:entry id=9a3f38e6-177a-46ea-9243-f6c2646dd072 slug=spec-api/generated-documents/summary/next-slice-rule-target-backed-spec-artifacts/descriptor-contract/l85 -->
...
<!-- rule-api:entry id=6a994ba9-2014-4984-9a18-7283353802e8 slug=spec-api/generated-documents/summary/next-slice-rule-target-backed-spec-artifacts/descriptor-validation/l89 -->
### Descriptor validation

The current descriptor implementation rejects:

<!-- rule-api:entry id=c7803a26-fb05-46c2-a8a9-4681e645a988 slug=spec-api/generated-documents/summary/next-slice-rule-target-backed-spec-artifacts/descriptor-validation/l93 -->
...
<!-- rule-api:entry id=42953cc1-9983-4074-885b-eec548816864 slug=spec-api/generated-documents/summary/next-slice-rule-target-backed-spec-artifacts/planned-acceptance-criteria-for-the-next-slice/l98 -->
...
<!-- rule-api:entry id=97647246-e24e-48f8-970c-8e2e464f2346 slug=spec-api/generated-documents/summary/next-slice-rule-target-backed-spec-artifacts/implementation-status/l105 -->
### Implementation status

The `spec-cli` orchestration slice is now implemented behind `spec sync-generated <spec-id>`.

<!-- rule-api:entry id=b92abfc0-7b4b-4815-b64c-05a8e1d34009 slug=spec-api/generated-documents/summary/next-slice-rule-target-backed-spec-artifacts/implementation-status/l109 -->
...
<!-- rule-api:entry id=bfcc40c9-422f-4048-b26b-21d8c22129b0 slug=spec-api/generated-documents/summary/next-slice-rule-target-backed-spec-artifacts/validation-status/l114 -->
### Validation status
...
<!-- rule-api:entry id=152dcba7-8bca-4231-b7e5-1970de77b539 slug=spec-api/generated-documents/summary/related-tickets/l119 -->
## Related tickets
...
<!-- rule-api:entry id=ac096ea4-df1c-40f6-9fdf-35ea461b6a69 slug=spec-api/generated-documents/summary/related-specs/l127 -->
## Related specs
